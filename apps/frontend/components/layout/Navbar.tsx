    ...
    >
      <div className="flex items-center gap-10">
        ...
        <nav className="hidden md:flex gap-6 text-[#A1A1AA] text-sm font-medium">
          <Link href="/listings" className="hover:text-secondary transition-colors">Marketplace</Link>
          <Link href="/listings?category=NEET" className="hover:text-white transition-colors">NEET</Link>
          <Link href="/listings?category=JEE" className="hover:text-white transition-colors">JEE</Link>
          <Link href="/listings?category=UPSC" className="hover:text-white transition-colors">UPSC</Link>
        </nav>
      </div>
